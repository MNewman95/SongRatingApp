...
namespace SongRatingApp
{
    public class SongsRepository : ISongsRepository
    {
        ...
        public double GetAvg(int songID )
        {


            return _conn.QuerySingle < double>("select " +
            " CASE" +

            " WHEN avg(ratings.ratingValue) IS NULL THEN 0" +
            " ELSE avg(ratings.ratingValue) END AS AverageRating" +
